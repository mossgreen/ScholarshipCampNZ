    ...
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
                ...
                s => s.Name, s => s.StartDate, s => s.Budget, s => s.InstructorID))
            {
                ...
                {
                    /*when the Entity Framework creates a SQL UPDATE command, 
                     * that command will include a WHERE clause that looks for a row 
                     * that has the original RowVersion value. 
                     * If no rows are affected by the UPDATE command 
                     * (no rows have the original RowVersion value),
                     * the Entity Framework throws a DbUpdateConcurrencyException exception*/

                    /*exception gets the affected Department entity that has the updated values 
                     * from the Entries property on the exception object.*/
                    var exceptionEntry = ex.Entries.Single();

                    /* You can use that object to get the new values entered 
                    ...
                    else
                    {
                        ...
                        /*the code sets the RowVersion value of the departmentToUpdate
                         * to the new value retrieved from the database. */
        ...
        {
            /*The method accepts an optional parameter that indicates
             * whether the page is being redisplayed after a concurrency error*/
            if (id == null)
            {
                return NotFound();
            }
            ...
            if (department == null)
            {
                ...
                /*deleted by another user, redirect to index page*/
